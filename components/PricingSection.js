            ...
            <div className="max-w-7xl mx-auto px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-4xl mx-auto">
                    ...
                    <div className="bg-slate-50 p-10 rounded-[50px] border-2 border-slate-100 flex flex-col items-center text-center">
                        ...
                        <div className="text-5xl font-black text-slate-900 tracking-tighter mb-6">₹499<span className="text-sm font-bold text-slate-400">/mo</span></div>
                    ...
                    <div className="bg-slate-900 p-10 rounded-[50px] border-[6px] border-indigo-500/20 flex flex-col items-center text-center relative overflow-hidden scale-105 shadow-2xl">
                        <div className="absolute top-6 right-6 bg-indigo-600 text-white text-[8px] font-black uppercase tracking-widest px-3 py-1 rounded-full animate-pulse">🔥 Most Popular</div>
                        ...
                        <div className="text-5xl font-black text-white tracking-tighter mb-6">₹1499<span className="text-sm font-bold text-slate-500">/mo</span></div>
                        <ul className="space-y-4 mb-10 text-left w-full">
