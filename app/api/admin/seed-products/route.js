...
export async function POST(req) {
    try {
        ...
        const ayurvedic = [
            ...
            { name: "Shilajit Resume", category: "Ayurvedic", price: 999, description: "Strength and stamina", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9d/Shilajit.jpg/800px-Shilajit.jpg", stock: 10 },
        ...
        return NextResponse.json({ success: true, message: "Added 20 sample products!" });
    } catch (error) {
