    ...
    try {
        ...
        if ((products.length === 0 || forceSeed) && !category && !search) {
            const seedProducts = [
                ...
                { name: "Pan 40 Tablet", description: "Pantoprazole. Effective for acidity and gastric issues.", price: 140.00, image: "https://images.unsplash.com/photo-1584308666744-24d59b298f0d?auto=format&fit=crop&w=400&q=80", category: "Acidity", requiresPrescription: true, stock: 90, uses: "Acidity, Heartburn" }
            ];
            try {
