            ...
            <main className="max-w-7xl mx-auto px-6 pt-32 pb-24">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-12">
                    <div>
                        ...
                        <h1 className="text-4xl font-black text-slate-900 mb-2">Verified Pathology Labs in Gorakhpur</h1>
                        <p className="text-slate-500 font-medium">Book blood tests and checkups with Gorakhpur's top-rated diagnostic centers.</p>
                    </div>

                    <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 flex items-center gap-4 max-w-sm">
                         <div className="w-12 h-12 bg-blue-600 text-white rounded-xl flex items-center justify-center shadow-lg"><i className="fa-solid fa-flask-vial"></i></div>
                         <div>
                            <p className="text-xs font-black text-slate-900 mb-1">Are you a Lab Owner?</p>
                            <a href="/partner" className="text-[10px] font-black text-blue-600 uppercase tracking-widest hover:underline">Register center here →</a>
                         </div>
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        {labs.length === 0 && (
                            <div className="col-span-full py-20 text-center font-bold text-slate-400">
                                No diagnostic labs found in Gorakhpur yet.
                            </div>
                        )}
                    </div>
                )}
