        ...
        <div className="bg-slate-50 min-h-screen font-sans">
            ...
            <div className="bg-emerald-600 pt-32 pb-20 px-6 text-center text-white">
                <div className="max-w-4xl mx-auto">
                    <div className="inline-block bg-white/20 px-4 py-1.5 rounded-full text-sm font-bold uppercase tracking-wider mb-6">
                        <i className="fa-solid fa-indian-rupee-sign mr-2"></i> Save up to 80% on Medicines
                    </div>
                    ...
                    <p className="text-lg md:text-xl text-emerald-100 font-medium max-w-2xl mx-auto leading-relaxed">
                        Why pay for a brand name? Generic medicines have the exact same active ingredients, quality, and effectiveness as expensive branded medicines, but cost a fraction of the price.
                    </p>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-6 py-16">
                <div className="flex justify-between items-center mb-8">
                    <h2 className="text-2xl font-black text-slate-800">Showing {filteredMedicines.length} Medicines</h2>
                </div>
                        ...
                        {filteredMedicines.map((med) => {
                            ...
                            return (
                                <div key={med.id} className="bg-white rounded-3xl p-6 border border-slate-100 shadow-sm hover:shadow-xl transition-all group flex flex-col h-full relative overflow-hidden">
                                    <div className="absolute top-0 right-0 bg-rose-500 text-white text-[10px] font-black px-3 py-1 rounded-bl-xl uppercase tracking-widest">
                                        Save {savingsPercent}%
                                    </div>
