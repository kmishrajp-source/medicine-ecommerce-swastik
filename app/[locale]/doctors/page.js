...
export default function DoctorsPage() {
    ...
    const specialties = ["All", "General Physician", "Cardiologist", "Dermatologist", "Pediatrician", "Gynecologist", "Orthopedic", "ENT Specialist"];
    const areas = ["All", "Betiahata", "Golghar", "Gorakhnath", "Medical College", "Asuran", "Kunraghat"];
