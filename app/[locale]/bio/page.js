      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8 hover:shadow-xl transition-shadow group relative overflow-hidden">
            ...
            <button className="text-blue-600 font-semibold hover:text-blue-800 flex items-center group-hover:gap-2 transition-all">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8 hover:shadow-xl transition-shadow group relative overflow-hidden">
            ...
            <button className="text-emerald-600 font-semibold hover:text-emerald-800 flex items-center group-hover:gap-2 transition-all">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8 hover:shadow-xl transition-shadow group relative overflow-hidden">
            ...
            <button className="text-amber-600 font-semibold hover:text-amber-800 flex items-center group-hover:gap-2 transition-all">
