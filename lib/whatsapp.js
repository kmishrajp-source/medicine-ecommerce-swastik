...
export const WhatsAppTriggers = {
    ...
    // Rich admin alert
    adminRichOrderAlert: (adminPhone, orderId, customerName, customerPhone, amount, itemsCount, address, invoiceUrl, aiDecision = "") =>
        sendWhatsAppMessage(adminPhone, "admin_rich_order_alert", [orderId, customerName, customerPhone, amount, itemsCount, address, invoiceUrl, aiDecision]),
    ...
    // Simultaneous AI Dispatch alert
    simultaneousDispatchAlert: (phone, orderId, pickupType, pickupName, pickupAddress, deliveryAddress, amount) =>
        sendWhatsAppText(phone, `🚀 *AI Dispatch Alert*\n\nOrder #${orderId}\n\n*Pickup from [${pickupType}]:*\n${pickupName}\n${pickupAddress}\n\n*Deliver to:*\n${deliveryAddress}\n\nCollect: ₹${amount}\n\nPlease proceed immediately.`),
