  ...
  static async processRequest(query, userId) {
    ...
    try {
      ...
      // ── 0.5 BIO-HEALTH & GENOMICS ───────────────────────────────
        ...
        q.includes("biomarker") || q.includes("research") || q.includes("dna") ||
        q.includes("study") || q.includes("trial") || q.includes("gene") ||
        // Hindi
      ...
      // ── 3. DOCTOR / SYMPTOM ───────────────────────────────────────
        ...
        q.includes("appointment") || q.includes("feeling") ||
        // Symptoms
        q.includes("pain") || q.includes("ache") || q.includes("fever") ||
        q.includes("itch") || q.includes("rash") || q.includes("swelling") ||
        q.includes("cough") || q.includes("cold") || q.includes("chest") ||
        q.includes("headache") || q.includes("vomit") || q.includes("nausea") ||
        q.includes("sick") || q.includes("ill") || q.includes("hurt") ||
        // Hindi symptoms
        q.includes("डॉक्टर") || q.includes("चिकित्सक") || q.includes("अपॉइंटमेंट") ||
        q.includes("दर्द") || q.includes("बुखार") || q.includes("खुजली") ||
        q.includes("सूजन") || q.includes("खांसी") || q.includes("तकलीफ") ||
        // Bengali
        q.includes("ডাক্তার") || q.includes("চিকিৎসক") || q.includes("ব্যথা")
      ) {
