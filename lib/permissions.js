...
export const PAGE_PERMISSIONS = {
    ...
    'customer-intelligence': ['SUPER_ADMIN', 'ADMIN', 'CRM_STAFF'],
    'marketing-intelligence': ['SUPER_ADMIN', 'ADMIN', 'CRM_STAFF'],
    'supplier-intelligence': ['SUPER_ADMIN', 'ADMIN', 'OPERATIONS'],
...
export const ADMIN_MENU = [
    ...
    { label: '🎯 Customer Finder',    page: 'customer-intelligence', href: '/admin/customer-intelligence' },
    { label: '✨ Marketing & Videos',  page: 'marketing-intelligence', href: '/admin/marketing-intelligence' },
    { label: '📦 Supplier Finder',    page: 'supplier-intelligence', href: '/admin/supplier-intelligence' },
