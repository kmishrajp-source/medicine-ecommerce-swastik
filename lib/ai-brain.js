...
async function handleToolCall(toolCall) {
    ...
    try {
        if (name === "search_medicine") {
            ...
            if (/flu|severe pain|fever|headache/.test(s)) specialty = "General Physician";
            else if (/heart|chest pain|blood pressure/.test(s)) specialty = "Cardiologist";
            else if (/skin|rash|acne|hair/.test(s)) specialty = "Dermatologist";
            else if (/tooth|teeth|gum/.test(s)) specialty = "Dentist";
            else if (/stomach|digestion/.test(s)) specialty = "Gastroenterologist";
            else if (/bone|joint|fracture|back pain/.test(s)) specialty = "Orthopedic";
            else if (/eye|vision|sight/.test(s)) specialty = "Ophthalmologist";
            else if (/child|baby|pediatric/.test(s)) specialty = "Pediatrician";
            ...
            if (doctor) {
                ...
                result.data = { found: false, recommended_specialty: specialty, browse_link: "https://swastikmed.online/en/doctors" };
            }
